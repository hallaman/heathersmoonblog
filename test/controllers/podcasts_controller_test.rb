...
class PodcastsControllerTest < ActionController::TestCase
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post :create, podcast: { description: @podcast.description, main_image: @podcast.main_image, title: @podcast.title }
    end
  ...
  test "should update podcast" do
    patch :update, id: @podcast, podcast: { description: @podcast.description, main_image: @podcast.main_image, title: @podcast.title }
    assert_redirected_to podcast_path(assigns(:podcast))
  end

...
class MediaControllerTest < ActionController::TestCase
  ...
  test "should create medium" do
    assert_difference('Medium.count') do
      post :create, medium: { file: @medium.file, link: @medium.link, title: @medium.title }
    end
  ...
  test "should update medium" do
    patch :update, id: @medium, medium: { file: @medium.file, link: @medium.link, title: @medium.title }
    assert_redirected_to medium_path(assigns(:medium))
  end
